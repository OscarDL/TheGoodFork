...
function AdminCard({icon, size = 28, type = 'material', title, description, screen, navigation}) {
  return (
    <View style={{marginHorizontal: 10, marginVertical: 5}}>
      ...
      >
        <Icon size={size} name={icon} type={type} color='#111' style={{marginHorizontal: 8}}/>
    ...
    <View style={{...styles.container, paddingHorizontal: 0}}>
      <ScrollView>
        <View style={{marginVertical: 5}}>
          <AdminCard icon='assignment-ind' title='Manage staff member accounts' description='Description 1' screen='AdminRegisterStaff' navigation={navigation}/>
