    ...
    <View style={{...styles.container, paddingHorizontal: 0}}>
      <ScrollView>
        <View style={{marginVertical: 5}}>
          ...
          <StaffHomeCard icon='tags' size={26} type='font-awesome' title='Check food & drinks sales statistics' description='Description 5' screen='AdminSalesStats' navigation={navigation} />
