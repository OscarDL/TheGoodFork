        ...
        <ScrollView contentContainerStyle={{paddingVertical: 5}}>
          ...
          <View>
            {(type === 'admin' || type === 'all') && <>
              ...
              {staff?.map((staff, i) => staff.type == 'admin' && <BaseCard
            ...
            {(type === 'barman' || type === 'all') && <>
              ...
              {staff?.map((staff, i) => staff.type == 'barman' && <BaseCard
                key={i} icon='how-to-reg' title={`${staff?.firstName} ${staff?.lastName}`} subtitle={staff?.email}
                description={staff?.type} screen='AdminEditStaff' params={{staff}} navigation={navigation}
              />)}
            </>}
            ...
            {(type === 'cook' || type === 'all') && <>
              ...
              {staff?.map((staff, i) => staff.type == 'cook' && <BaseCard
                key={i} icon='how-to-reg' title={`${staff?.firstName} ${staff?.lastName}`} subtitle={staff?.email}
                description={staff?.type} screen='AdminEditStaff' params={{staff}} navigation={navigation}
              />)}
            </>}
            ...
            {(type === 'waiter' || type === 'all') && <>
              ...
              {staff?.map((staff, i) => staff.type == 'waiter' && <BaseCard
                key={i} icon='how-to-reg' title={`${staff?.firstName} ${staff?.lastName}`} subtitle={staff?.email}
                description={staff?.type} screen='AdminEditStaff' params={{staff}} navigation={navigation}
              />)}
            </>}
