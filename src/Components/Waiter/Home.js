    ...
    <View style={{...styles.container, paddingHorizontal: 0}}>
      <ScrollView>
        <View style={{marginVertical: 5}}>
          ...
          <TouchCard icon='app-registration' title='Nouvelle commande' description='Passer commande pour un client non-enregistré.' screen='WaiterNewOrder' navigation={navigation} />
