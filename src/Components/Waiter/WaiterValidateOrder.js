...
import OrderDetailsCard from '../../Reusables/OrderDetailsCard';
      ...
      <ScrollView>
        {orders?.length > 0 && <>
          <View style={{marginTop: 10}}>
            ...
            {orders?.map((order, i) => <OrderDetailsCard
              key={i} title={order?.mainDish[0].name} subtitle={order?.price + ' ' + order?.currency}
